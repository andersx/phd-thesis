...
\begin{figure}%
    ...
    \subfloat[Side view of folding stage lowest energy sample (blue).]{
        {\includegraphics[width=0.4\textwidth]{figures/rhodopsin_figures/folding.pdf}}
    }\quad
    \subfloat[Side view of refinement stage lowest energy sample (red).]{
        {\includegraphics[width=0.4\textwidth]{figures/rhodopsin_figures/refinement.pdf}}
    }\\
